...
d3.csv("data.csv", function (error, data) {
  ...
  var labels = [{ 
	...
	data: { year: "1974", death: 14526, law: "Limitation à 130 km/h sur les autoroutes, 110 km/h sur les voies expresses et 90 km/h sur les routes" },
    dy: 120,
    dx: -60
  }, {
    ...
    l.note = Object.assign({}, l.note, { title: l.data.year + l.data.death,
      label: "" + l.data.law });
    l.subject = { radius: 4 };
